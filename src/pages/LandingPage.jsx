  ...
  return (
    <div className="container">
      ...
      <nav className="navbar flex justify-between items-center p-4">
        <div className="nav-title font-bold text-lg">Ente Gramam</div>
        <div className="nav-links">
          <button
            onClick={handleGetStarted}
            className="login-btn px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700"
          >
            Login
          </button>
        </div>
      ...
      {/* Header Section */}
      <header className="welcome bg-[#E7F5FE] py-16">
        <div className="glass-container max-w-3xl mx-auto p-8 bg-white/20 backdrop-blur-sm rounded-lg text-center">
      ...
      <main className="max-w-3xl mx-auto p-6 space-y-8">
        ...
        <div className="btn-group flex justify-center space-x-4">
          <button
            onClick={handleGetStarted}
            className="login-btn px-6 py-2 bg-green-600 text-white rounded hover:bg-green-700"
          >
            Login
          </button>
          <a
            href="#"
            className="about-btn px-6 py-2 bg-gray-200 text-gray-800 rounded hover:bg-gray-300"
          >
            About Us
          </a>
        </div>
